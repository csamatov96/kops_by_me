...
resource "aws_key_pair" "kubernetes-csamatov-net-0a7d87edf171d7883d7882c58a50225a" {
  key_name   = "kubernetes.csamatov.net-0a:7d:87:ed:f1:71:d7:88:3d:78:82:c5:8a:50:22:5a"
  public_key = "${file("${path.module}/data/aws_key_pair_kubernetes.csamatov.net-0a7d87edf171d7883d7882c58a50225a_public_key")}"
}
...
resource "aws_launch_configuration" "bastions-csamatov-net" {
  ...
  key_name                    = "${aws_key_pair.kubernetes-csamatov-net-0a7d87edf171d7883d7882c58a50225a.id}"
